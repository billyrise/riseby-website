...
- **No.**: 3 / 163
- **slug**: ai-assurance-vs-audit
- **title_ja**: 保証と監査の分界：証憑の形
- **template_id**: T08
- **unique_focus**: “Assuranceの限界と証憑の形”に特化
- **対象読者**: Audit（Exec=経営層 / Pract=実務 / Audit=監査 / Legal=法務・コンプラ / Multi=複数）
...
- **冒頭パターン（Op）**: 3 — 問いかけ
  - 例: 「あなたの会社のAI利用申請、承認者は誰か即答できますか？」
- **結論パターン（Co）**: 3 — 長期視点
  - 例: 「いまの対応が、その後の競争力の基盤を決める」
...
| No. | slug | 図1 | 図2 | 図3 |
|-----|------|-----|-----|-----|
| 1 | accountability-incident-design | A | G | F |
| 2 | ai-access-control-zerotrust | D | B | G |
