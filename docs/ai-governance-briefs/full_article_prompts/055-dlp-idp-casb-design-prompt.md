# 記事 No. 55：ツール設計（DLP/IDP/CASB）

## 入力

- **slug**: dlp-idp-casb-design
- **title_ja**: ツール設計（DLP/IDP/CASB）
- **unique_focus**: “ツール設計（DLP/IDP/CASB）”に特化
- **template_id**: T22
- **記事DNA**: 読者=Pract, 目的=Impl, 深さ=Deep, スタイル=Prescriptive
- **必須セクション見出し**: 漏えい経路, 統制, 運用, 監査提示
