# 記事 No. 84：GPAI/LLMの境界と責任

## 入力

- **slug**: gpai-llm-governance-overview
- **title_ja**: GPAI/LLMの境界と責任
- **unique_focus**: “GPAI/LLMの境界と責任”に特化
- **template_id**: T27
- **記事DNA**: 読者=Multi, 目的=Understand, 深さ=Overview, スタイル=Analytical
- **必須セクション見出し**: 境界定義, 統制, 契約, 運用
