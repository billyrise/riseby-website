# 記事 No. 147：子会社・SME向け軽量統制

## 入力

- **slug**: subsidiary-sme-lightweight-governance
- **title_ja**: 子会社・SME向け軽量統制
- **unique_focus**: “軽量統制モデル”に特化
- **template_id**: T03
- **記事DNA**: 読者=Exec, 目的=Navigate, 深さ=Overview, スタイル=Comparative
