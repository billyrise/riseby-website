...
- **No.**: 9 / 163
- **slug**: ai-ethics-principles-policy
- **title_ja**: AI倫理原則を手続きに変換する
- **template_id**: T01
- **unique_focus**: “理念→手続きへ変換”に特化
...
直近5記事の図で使われた形式: **SVG, HTML, Table, SVG, HTML, Table, SVG, HTML, Table, Mermaid, Mermaid, Mermaid, Mermaid, Mermaid, Mermaid**  
