...
本稿の焦点は「“軽量統制モデル”」です。子会社・SME向け軽量統制について、責任分界・証跡・監査提出の目次を具体化します。年次で優先5領域を決め、予算・人材・レビューのサイクルを回します。 開発段階の統制と承認ゲートを設け、証跡を切らさない設計にします。

## 本文

### 1. モデル選定

本稿の焦点は「“軽量統制モデル”」です。モデル選定では、理念で終わらせず運用・証跡・監査可能性に落とすための要件を整理します。RACI、申請―審査―例外―更新、証跡、継続評価、インシデントの5要素のうち、このテーマに応じた項目を押さえます。年次で優先5領域を決め、予算・人材・レビューのサイクルを回します。 開発段階の統制と承認ゲートを設け、証跡を切らさない設計にします。
...
<div style="max-width: 520px; margin: 1rem auto; border-left: 3px solid #003E68; padding-left: 1rem;">
  <p style="margin: 0 0 0.5rem; font-weight: bold;">モデル選定と運用</p>
...
<table style="width:100%; max-width: 520px; margin: 1rem auto; border-collapse: collapse;">
  ...
  <tbody>
    <tr><td style="border: 1px solid #cbd5e1; padding: 0.5rem 0.75rem;">ガードレール・計画</td><td style="border: 1px solid #cbd5e1; padding: 0.5rem 0.75rem;">選択の根拠</td></tr>
...
<svg viewBox="0 0 220 120" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="110" y="115" text-anchor="middle" font-size="8" fill="#64748b">移行計画</text>
</svg>
```
...
監査で問われやすいのは「“軽量統制モデル”」に関して、責任分界と証跡の目次が揃っていないことです。明日から、監査提出に必要な証跡の目次をリスト化し、監査法人に事前に1回提示して問題ないか確認してください。
