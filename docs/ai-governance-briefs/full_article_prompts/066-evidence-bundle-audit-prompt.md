# 記事 No. 66：監査提出の形（Evidence Bundle）

## 入力

- **slug**: evidence-bundle-audit
- **title_ja**: 監査提出の形（Evidence Bundle）
- **unique_focus**: “監査提出の形”に特化
- **template_id**: T18
- **記事DNA**: 読者=Audit, 目的=Audit, 深さ=Deep, スタイル=Prescriptive
- **必須セクション見出し**: 連鎖設計, 実装, 運用, 監査提示
