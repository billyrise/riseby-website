# 記事 No. 73：GDPR×GenAI：個人データ論点

## 入力

- **slug**: gdpr-genai-personal-data
- **title_ja**: GDPR×GenAI：個人データ論点
- **unique_focus**: “個人データ論点”に特化
- **template_id**: T26
- **記事DNA**: 読者=Legal, 目的=Understand, 深さ=Overview, スタイル=Analytical
- **必須セクション見出し**: 何が論点か, 運用, 証跡, チェックリスト
