...
- **No.**: 13 / 163
- **slug**: ai-lifecycle-overview
- **title_ja**: ライフサイクルに評価ゲートを埋め込む
- **template_id**: T14
- **unique_focus**: “ライフサイクルに評価ゲートを埋め込む”に特化
...
### Points（書くべきポイント）
evals basics、継続評価、ドリフト、評価自動化、レッドチーム

### Infographics（使うべきインフォグラフィック3種の「型」）
1) CI/CDゲート図 2) KPI/KRI（品質・安全） 3) ライフサイクル輪
