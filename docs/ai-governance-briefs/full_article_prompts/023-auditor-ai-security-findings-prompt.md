# 記事 No. 23：監査所見と是正テンプレ

## 入力

- **slug**: auditor-ai-security-findings
- **title_ja**: 監査所見と是正テンプレ
- **unique_focus**: “監査所見→是正テンプレ”に特化
- **template_id**: T09
- **記事DNA**: 読者=Audit, 目的=Audit, 深さ=Quick, スタイル=Prescriptive
- **必須セクション見出し**: 所見の型, 原因, 是正テンプレ, 追跡KPI
