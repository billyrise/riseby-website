...
本稿の焦点は「“品質KRIと閾値”」です。データ品質KRIと閾値について、責任分界・証跡・監査提出の目次を具体化します。当局報告の責任分界を事前に決め、インシデント設計に反映させます。 定性・定量の使い分けとリスク評価の手順を文書化し、継続評価を回します。

## 本文

### 1. 品質が壊れる点

本稿の焦点は「“品質KRIと閾値”」です。品質が壊れる点では、理念で終わらせず運用・証跡・監査可能性に落とすための要件を整理します。RACI、申請―審査―例外―更新、証跡、継続評価、インシデントの5要素のうち、このテーマに応じた項目を押さえます。当局報告の責任分界を事前に決め、インシデント設計に反映させます。 定性・定量の使い分けとリスク評価の手順を文書化し、継続評価を回します。
...
<div style="max-width: 520px; margin: 1rem auto; border-left: 3px solid #003E68; padding-left: 1rem;">
  <p style="margin: 0 0 0.5rem; font-weight: bold;">品質が壊れる点と運用</p>
...
<table style="width:100%; max-width: 520px; margin: 1rem auto; border-collapse: collapse;">
  ...
  <tbody>
    <tr><td style="border: 1px solid #cbd5e1; padding: 0.5rem 0.75rem;">測定・計画</td><td style="border: 1px solid #cbd5e1; padding: 0.5rem 0.75rem;">選択の根拠</td></tr>
...
<svg viewBox="0 0 320 70" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="160" y="62" text-anchor="middle" font-size="8" fill="#64748b">是正</text>
</svg>
```
...
監査で問われやすいのは「“品質KRIと閾値”」に関して、責任分界と証跡の目次が揃っていないことです。明日から、監査提出に必要な証跡の目次をリスト化し、監査法人に事前に1回提示して問題ないか確認してください。
