# 記事 No. 36：なぜ今、コンテンツ透明性か

## 入力

- **slug**: content-transparency-why-now
- **title_ja**: なぜ今、コンテンツ透明性か
- **unique_focus**: “なぜ今（誤情報/深層偽造）”に特化
- **template_id**: T32
- **記事DNA**: 読者=Multi, 目的=Understand, 深さ=Quick, スタイル=Narrative
