...
- **No.**: 8 / 163
- **slug**: ai-ethics-committee-design
- **title_ja**: AI倫理委員会が形骸化しない設計
- **template_id**: T11
- **unique_focus**: “委員会が形骸化しない設計”に特化
...
- **冒頭パターン（Op）**: 8 — 逆説
  - 例: 「AI倫理原則を掲げる企業ほど、実装で躓く—理念と手続きの断絶」
- **結論パターン（Co）**: 3 — 長期視点
...
直近5記事の図で使われた形式: **Mermaid, Mermaid, Mermaid, SVG, HTML, Table, SVG, HTML, Table, SVG, HTML, Table, Mermaid, Mermaid, Mermaid**  
