# 記事 No. 59：倫理×セキュリティ統制統合

## 入力

- **slug**: ethics-security-unified-control
- **title_ja**: 倫理×セキュリティ統制統合
- **unique_focus**: “倫理×セキュリティ統制統合”に特化
- **template_id**: T01
- **記事DNA**: 読者=Multi, 目的=Understand, 深さ=Overview, スタイル=Analytical
- **必須セクション見出し**: なぜAIで三線が崩れるか, RACI最小セット, 例外が燃える構造と封じ方, 実装チェックリスト
