# 記事 No. 62：禁止類型の整理（マトリクス）

## 入力

- **slug**: eu-ai-act-prohibited
- **title_ja**: 禁止類型の整理（マトリクス）
- **unique_focus**: “禁止類型の整理（マトリクス）”に特化
- **template_id**: T26
- **記事DNA**: 読者=Legal, 目的=Understand, 深さ=Quick, スタイル=Analytical
