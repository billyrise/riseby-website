# 記事 No. 76：グローバル基準×ローカル適用

## 入力

- **slug**: global-baseline-local-adaptation
- **title_ja**: グローバル基準×ローカル適用
- **unique_focus**: “グローバル基準×ローカル”に特化
- **template_id**: T03
- **記事DNA**: 読者=Multi, 目的=Navigate, 深さ=Overview, スタイル=Comparative
- **必須セクション見出し**: モデル選定, ガードレール, 移行計画, 失敗例
