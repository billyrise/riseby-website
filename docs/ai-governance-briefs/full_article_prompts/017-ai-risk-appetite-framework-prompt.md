# 記事 No. 17：レッドライン定義とリスク許容度

## 入力

- **slug**: ai-risk-appetite-framework
- **title_ja**: レッドライン定義とリスク許容度
- **unique_focus**: “レッドライン定義”に特化
- **template_id**: T06
- **記事DNA**: 読者=Exec, 目的=Decide, 深さ=Overview, スタイル=Analytical
- **必須セクション見出し**: 許容度設計, 承認運用, 例外, KRI
