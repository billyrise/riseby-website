# 記事 No. 26：領域別の公平性論点（人事・与信・医療）

## 入力

- **slug**: bias-fairness-hr-credit-healthcare
- **title_ja**: 領域別の公平性論点（人事・与信・医療）
- **unique_focus**: “領域別の公平性論点”に特化
- **template_id**: T07
- **記事DNA**: 読者=Multi, 目的=Understand, 深さ=Overview, スタイル=Comparative
- **必須セクション見出し**: 評価設計, 実施と記録, 継続評価
