# 記事 No. 43：CXO役割分担（RACI）

## 入力

- **slug**: cxo-roles-ai-governance
- **title_ja**: CXO役割分担（RACI）
- **unique_focus**: “CXO役割分担（RACI）”に特化
- **template_id**: T02
- **記事DNA**: 読者=Exec, 目的=Decide, 深さ=Overview, スタイル=Prescriptive
