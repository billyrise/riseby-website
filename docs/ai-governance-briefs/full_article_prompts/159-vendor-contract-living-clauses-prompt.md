# 記事 No. 159：living clausesの運用

## 入力

- **slug**: vendor-contract-living-clauses
- **title_ja**: living clausesの運用
- **unique_focus**: “living clauses運用”に特化
- **template_id**: T25
- **記事DNA**: 読者=Legal, 目的=Impl, 深さ=Quick, スタイル=Prescriptive
- **必須セクション見出し**: 選定基準, 評価プロセス, 契約・SLA, 継続監視
