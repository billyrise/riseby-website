# 記事 No. 140：Safety caseの証拠構造

## 入力

- **slug**: safety-case-accountability
- **title_ja**: Safety caseの証拠構造
- **unique_focus**: “Safety caseの証拠構造”に特化
- **template_id**: T08
- **記事DNA**: 読者=Audit, 目的=Audit, 深さ=Deep, スタイル=Analytical
- **必須セクション見出し**: 用語定義, 分界, 成果物, 実装の勘所
