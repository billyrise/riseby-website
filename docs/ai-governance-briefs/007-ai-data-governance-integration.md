...
- **No.**: 7 / 163
- **slug**: ai-data-governance-integration
- **title_ja**: データ統制とAI統制の接合点
- **template_id**: T26
- **unique_focus**: “データ統制とAI統制の接合点”に特化
...
- **冒頭パターン（Op）**: 7 — タイムリミット
  - 例: 「高リスクAIの適合性評価、2026年8月までに体制構築が必須」
- **結論パターン（Co）**: 2 — 判断軸の提供
  - 例: 「あなたの組織がどの道を選ぶべきか、5つの質問」
...
### Points（書くべきポイント）
GDPR×GenAI、個人情報、目的外利用、権利対応（断定禁止）

### Infographics（使うべきインフォグラフィック3種の「型」）
1) マトリクス（データ種類×義務） 2) レイヤー図 3) フロー（DPIA/承認）
...
直近5記事の図で使われた形式: **Mermaid, Mermaid, Mermaid, Mermaid, Mermaid, Mermaid, SVG, HTML, Table, SVG, HTML, Table, SVG, HTML, Table**  
