# 記事 No. 21：取締役会向け最小KRIとダッシュボード

## 入力

- **slug**: audit-dashboard-board-metrics
- **title_ja**: 取締役会向け最小KRIとダッシュボード
- **unique_focus**: “取締役会向け最小KRI”に特化
- **template_id**: T20
- **記事DNA**: 読者=Exec, 目的=Decide, 深さ=Quick, スタイル=Prescriptive
- **必須セクション見出し**: 何を見るか, 誰が見るか, 閾値, アクション
