# 記事 No. 24：BCPとAI依存：停止・代替・復旧

## 入力

- **slug**: bcp-ai-dependency-failsafe
- **title_ja**: BCPとAI依存：停止・代替・復旧
- **unique_focus**: “停止/代替手段/復旧”に特化
- **template_id**: T15
- **記事DNA**: 読者=Pract, 目的=Impl, 深さ=Overview, スタイル=Prescriptive
- **必須セクション見出し**: 退役が監査で燃える理由, 手順, 証跡, チェックリスト
