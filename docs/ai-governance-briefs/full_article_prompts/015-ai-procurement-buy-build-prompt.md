# 記事 No. 15：Buy/Build判断の評価軸

## 入力

- **slug**: ai-procurement-buy-build
- **title_ja**: Buy/Build判断の評価軸
- **unique_focus**: “Buy/Build判断の評価軸”に特化
- **template_id**: T25
- **記事DNA**: 読者=Exec, 目的=Decide, 深さ=Overview, スタイル=Comparative
