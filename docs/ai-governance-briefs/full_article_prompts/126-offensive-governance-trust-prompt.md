# 記事 No. 126：信頼を攻めの資産に（具体化）

## 入力

- **slug**: offensive-governance-trust
- **title_ja**: 信頼を攻めの資産に（具体化）
- **unique_focus**: “信頼を攻めの資産へ（具体化）”に特化
- **template_id**: T02
- **記事DNA**: 読者=Exec, 目的=Decide, 深さ=Quick, スタイル=Narrative
